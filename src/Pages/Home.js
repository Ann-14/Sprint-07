...
export const Home = () => {
  ...
  return (
    <>
      ...
      <div class="flex mb-4 flex-col md:flex-row md:mt-16">
        {/* columna texto */}
          <div className="w-full md:w-1/2 h-9 pt-16 p-4 text-center md:mt-20 ">
            <h1 className="font text-4xl lg:text-5xl font-bold tracking-tight text-pink-100 text-center">
              Get the help you need, every step of the way
            </h1>
            <p className="mt-4 text-xl lg:text-2xl md:p-4 text-pink-200">
              Upgrade YOUR business for better future. Create or upgrade your websites and spend less with Essentials.
            </p>
          </div>
          
          {/* Columna imagen */}
          <div className="mt-28 md:mt-0 p-8 md:w-1/2">
