...
export const Main = () => {
  ...
  const handleChange = (event) => {
    const foundBudgets = budgetsList.filter(
      (elem) => elem.budgetName === event.target.value
    );
    foundBudgets.length > 0
      ? setBudgetsList(foundBudgets)
      : setBudgetsList(budgets);
  };
    ...
    <>
        ...
        <div className="flex  flex-col  p-4  md:flex-row md:gap-4 justify-center">
          ...
          <div className="flex text-center flex-col ">
            <img
              src={fotoSeo}
              alt="Seo services"
              className="rounded  md:w-80 mb-4"
            />
            <CheckBox
      ...
      <div className="flex flex-col text-pink-100 text-center">
        ...
        <div>
          <button
            onClick={submitData}
            className=" mt-3 justify-center inline-block rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-center font-medium text-white  hover:bg-indigo-700 "
          >
            Submit
          </button>
        </div>
      ...
      <div className="flex flex-col text-pink-100 text-center">
        <div>
          <label
            htmlFor="findBudgetName"
            className="d-block mt-4 justify-center"
          ></label>
          <div className="flex justify-center">
          ...
          <div className="flex gap-2 justify-center mt-4 mb-4">
            <button
              onClick={handleReset}
              className="flex rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-center text-white  hover:bg-indigo-700"
            >
              Reset
            </button>
            <button
